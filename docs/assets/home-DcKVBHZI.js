import{r as l}from"./site-BJZP0k5J.js";const o="https://review.alphazonelabs.com/api/reviews/published";function i(e=""){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function c(e){const s=Math.max(1,Math.min(5,Number(e.rating||5)));return`
