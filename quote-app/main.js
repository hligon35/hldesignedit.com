...
window.addEventListener('message',e=>{if(e.data?.type==='ALPHA_QUOTE_SUCCESS')showThanks();if(e.data?.type==='ALPHA_QUOTE_ERROR'){next.disabled=false;next.textContent='Submit request';fail('We could not submit the form. Please try again.')}});
